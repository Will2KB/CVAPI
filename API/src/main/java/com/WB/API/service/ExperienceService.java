...
public class ExperienceService {
	 ...
	 * 
	 * @return Retourne un objet de transfert ou NULL si aucune expérience n'est
	 *         trouvée
	 */
	...
	/**
	 * Récupére la liste de toutes les expériences qui existent en base de donnée
	 * 
	 * @return Retourne une liste d'objet de transfert
	 */
	public List<ExperienceSummaryDTO> getExperiences() {
		List<ExperienceSummaryDTO> exprienceSummariesDTO = ExperienceMapper
				.toSummaryDTOList(experienceRepository.findAll());

		// Si aucune expérience n'est trouvée
