...
public interface PersonRepository extends CrudRepository<Person, Integer> {
	 ...
	 * 
	 * @Return Retourn une liste d'entité personne
	 */
	public List<Person> findAll();

	/*
	 * Permet de récupérer la première occurance trouvée correspondant au nom et au
	 * prénom
	 * 
	...
	/*
	 * Permet de récupérer la première occurance trouvée correspondant à l'email
	 * recherché
	 * 
